...
import PostProcStragegy from '@/pages/postproc/strategy';
  ...
  return (
    <div className='content'>
      <Switch>
        ...
        <Route exact path='/proc-rules/add/:group_id' component={StrategyAdd} />
        <Route exact path='/proc-rules/edit/:id' component={StrategyEdit} />
        <Route exact path='/proc-rules/:id?' component={PostProcStragegy} />
